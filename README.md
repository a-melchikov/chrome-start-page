...
- включённый по умолчанию статический Liquid Glass для Markdown и Search:
  полупрозрачный фон, размытие, светлая кромка и тень с учётом темы;
...
В схеме v4 поле `appearance.liquidGlassEnabled` хранит состояние эффекта;
его можно выключить в закрытом по умолчанию разделе «Виджеты» окна
«Оформление».
...
поддерживается, остаются полупрозрачный фон, рамка и тень.
