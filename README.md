...
- виджет погоды с визуальным и компактным режимами, поиском городов через
  Open-Meteo Geocoding, определением текущего местоположения, детальными
  показателями, 12-часовым и 5-дневным прогнозом;
